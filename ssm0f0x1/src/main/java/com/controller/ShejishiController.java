...
public class ShejishiController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		...
		String token = tokenService.generateToken(user.getId(), username,"shejishi",  "设计师" );
    ...
    public R register(@RequestBody ShejishiEntity shejishi){
    	...
    	ShejishiEntity user = shejishiService.selectOne(new EntityWrapper<ShejishiEntity>().eq("shejishizhanghao", shejishi.getShejishizhanghao()));
		if(user!=null) {
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		int count = shejishiService.selectCount(wrapper);
