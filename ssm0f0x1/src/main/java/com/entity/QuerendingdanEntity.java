...
public class QuerendingdanEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public QuerendingdanEntity() {
		
	}
	
	public QuerendingdanEntity(T t) {
		try {
	 ...
	 * 设置：确认编号
	 */
	public void setQuerenbianhao(String querenbianhao) {
		this.querenbianhao = querenbianhao;
	}
	/**
	 * 获取：确认编号
	 */
	public String getQuerenbianhao() {
		return querenbianhao;
	}
	/**
	 * 设置：作品名称
	 */
