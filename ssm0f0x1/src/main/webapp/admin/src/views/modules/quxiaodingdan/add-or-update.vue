    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="取消备注" prop="quxiaobeizhu">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.quxiaobeizhu" label="取消备注" prop="quxiaobeizhu">
                    <span v-html="ruleForm.quxiaobeizhu"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.quxiaobeizhu = this.ruleForm.quxiaobeizhu.replace(reg,'../../../ssm0f0x1/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
