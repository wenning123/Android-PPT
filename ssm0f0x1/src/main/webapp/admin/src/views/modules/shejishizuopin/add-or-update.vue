    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="作品编号" prop="zuopinbianhao">
            <el-input v-model="ruleForm.zuopinbianhao" 
                placeholder="作品编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.zuopinbianhao" label="作品编号" prop="zuopinbianhao">
              <el-input v-model="ruleForm.zuopinbianhao" 
                placeholder="作品编号" readonly></el-input>
          </el-form-item>
        </div>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          var json = data.data;
		if(json.shejishizhanghao!=''&&json.shejishizhanghao){
                this.ruleForm.shejishizhanghao = json.shejishizhanghao
	    		this.ro.shejishizhanghao = true;
		}
		if(json.shejishixingming!=''&&json.shejishixingming){
                this.ruleForm.shejishixingming = json.shejishixingming
	    		this.ro.shejishixingming = true;
		}
		if(json.shejishidianhua!=''&&json.shejishidianhua){
                this.ruleForm.shejishidianhua = json.shejishidianhua
	    		this.ro.shejishidianhua = true;
		}
        } else {
	...
	this.ruleForm.jianjie = this.ruleForm.jianjie.replace(reg,'../../../ssm0f0x1/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `shejishizuopin/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.shejishizuopinCrossAddOrUpdateFlag = false;
						 this.parent.search();
